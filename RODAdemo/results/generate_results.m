        ...
        switch b_pressed
            ...
            case 'Strategies'
                ...
                for i = 1:length(classifications)
                    ...
                    [~,p,~,~,vals,vals_grps,pos,~,strat_distr,time_per_segment] = results_strategies_distributions(segmentation_configs,classifications{i},animals_trajectories_map,0,dir_list{i},varargin{:});
