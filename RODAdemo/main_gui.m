...
function main_gui_OpeningFcn(hObject, eventdata, handles, varargin)
    ...
    DEMOoptions(hObject, eventdata, handles);
...
function DEMOoptions(hObject, eventdata, handles)
    set(handles.res_demo, 'Enable', 'off');
    set(handles.res_demo, 'Enable', 'off');
    set(handles.conf_tags,'Enable','off');
    set(handles.method_conf,'Enable','off');
    set(handles.classification_conf,'Enable','off');
    set(handles.check_labels,'Enable','off');
    set(handles.advanced_classification,'Enable','off');
